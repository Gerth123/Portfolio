...
export class MySkillsComponent {
  skills: { src: string; alt: string; name: string; }[] = [
    ...
    { src: '../../assets/icons/firebase.svg', alt: 'Firebase', name: 'Firebase' },
    { src: '../../assets/icons/git.svg', alt: 'Git', name: 'Git' },
    { src: '../../assets/icons/rest_api.svg', alt: 'Rest Api', name: 'Rest Api' },
    { src: '../../assets/icons/scrum.svg', alt: 'Scrum', name: 'Scrum' },
    { src: '../../assets/icons/material_design.svg', alt: 'Material Design', name: 'Material Design' },
    { src: '../../assets/icons/continually_learning.svg', alt: 'Continually Learning', name: 'Continually Learning' },
  ];
}
