...
export class ProjectsComponent {
  public translations: any = {
    en: {
      ...
      videoflixText: 'Streaming platform frontend built with Angular, focused on authentication, category-based browsing, favorites and a Continue Watching flow that stores video progress. The project highlights modular component structure, API-oriented thinking and user-centered media workflows.',
      liveTest: 'Live test',
    },
    de: {
      ...
      videoflixText: 'Streaming-Plattform-Frontend mit Angular, mit Fokus auf Authentifizierung, kategoriebasiertes Browsing, Favoriten und einen Continue-Watching-Flow, der Videofortschritt speichert. Das Projekt zeigt modulare Komponentenstruktur, API-orientiertes Denken und nutzerzentrierte Medien-Workflows.',
      liveTest: 'Live-Test',
    }
  };
